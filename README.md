...
This repository stores the modeling and analysis notebooks for the paper, [TDCOSMO XXVI: Uniform Lens Modeling of Eight Doubly Imaged Quasars](https://astro.theoj.org/article/166553-tdcosmo-xxvi-uniform-lens-modeling-of-eight-doubly-imaged-quasars). This repository is organized as follows:
...
To access the data products of [Brady et al. 2026](https://astro.theoj.org/article/166553-tdcosmo-xxvi-uniform-lens-modeling-of-eight-doubly-imaged-quasars), please visit the corresponding [Zenodo repository](https://zenodo.org/records/19421439). Upon downloading and opening the zipped directory, move ```brady_et_al_2026``` into this directory, and move each individual folder out of ```brady_et_al_2026``` and into this directory. The data products include:
